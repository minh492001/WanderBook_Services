...
//        RoomResponse response = new RoomResponse(savedRoom.getId(), savedRoom.getRoomType(), savedRoom.getPricePerNight());
...
//            }
//        }
//        return new RoomResponse(room.getId(), room.getRoomType(), room.getPricePerNight(), room.isBooked(), photoBytes);
//    }
//}
